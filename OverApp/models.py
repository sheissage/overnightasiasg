...
from OverAppHelper.models import BookCache
...
class HotelAvailability(models.Model):
    ...
    airportTransfer = models.FloatField(default=0)
    ratePerNight = models.FloatField(default=0)
    roomName = models.CharField(max_length=5120, blank=True, null=True)
    hotel = models.ForeignKey('OverApp.HotelInfo')
    merchant = models.ForeignKey('OverApp.Merchant')
...
class Gallery(models.Model):
    ...
    hotel = models.ForeignKey('OverApp.HotelInfo', blank=True, null=True)
    room = models.ForeignKey('OverApp.RoomInfo', blank=True, null=True)
    traveller = models.ForeignKey('OverApp.Traveller', blank=True, null=True)
